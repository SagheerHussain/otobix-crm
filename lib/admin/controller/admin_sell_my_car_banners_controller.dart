...
class AdminSellMyCarBannersController extends GetxController {
  ...
  Future<void> _loadBannersList() async {
    ...
    try {
      final response =
        ...
        'view': AppConstants.bannerViews.sellMyCar,
      });
...
// Add Banner
  Future<void> addBanner({
    ...
    try {
      ...
      request.fields['view'] = AppConstants.bannerViews.sellMyCar;
