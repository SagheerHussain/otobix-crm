...
class AdminDesktopDropdownsPage extends StatelessWidget {
  AdminDesktopDropdownsPage({super.key});

  final AdminDropdownsController adminDropdownsController =
      Get.put(AdminDropdownsController());
              ...
              children: [
                ...
                Expanded(
                  child: Obx(() => ListView.separated(
                        itemCount:
                            adminDropdownsController.dropdownsList.length,
                                ...
                                Expanded(
                                  ...
                                  child: dropdown.dropdownValues.isEmpty
                                      ...
                                      : Wrap(
                                          spacing: 8,
                                          runSpacing: 8,
                                          children: dropdown.dropdownValues
                                              .map((value) {
                                            return Container(
                                              padding:
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  "Manage dropdowns and their values",
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.grey[600],
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TextField(
                                controller:
                                    adminDropdownsController.newNameController,
                        ...
                        Obx(() {
                          if (adminDropdownsController.dropdownNames.isEmpty) {
                            return Container(
                          ...
                          return Container(
                            ...
                            child: ListView.builder(
                              shrinkWrap: true,
                              itemCount:
                                  adminDropdownsController.dropdownNames.length,
                              itemBuilder: (context, index) {
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TextField(
                                controller:
                                    adminDropdownsController.newValueController,
                                decoration: InputDecoration(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Obx(() => ElevatedButton(
                              onPressed: adminDropdownsController
                                      .isAddDropdownLoading.value
                                  ? null
                                  : () async {
                                      await adminDropdownsController
                                          .addNewDropdown();
                                    },
                              style: ElevatedButton.styleFrom(
                                backgroundColor: AppColors.green,
                              ...
                              child: adminDropdownsController
                                      .isAddDropdownLoading.value
                                  ? const SizedBox(
                                      width: 20,
                                      height: 20,
