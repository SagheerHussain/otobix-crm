...
import 'package:otobix_crm/admin/controller/admin_homepage_banners_controller.dart';
...
class AdminDesktopHomepageBannersPage extends StatelessWidget {
  AdminDesktopHomepageBannersPage({super.key});

  final AdminHomepageBannersController getxController =
      Get.put(AdminHomepageBannersController());
