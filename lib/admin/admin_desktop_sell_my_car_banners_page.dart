...
import 'package:otobix_crm/admin/controller/admin_sell_my_car_banners_controller.dart';
...
class AdminDesktopSellMyCarBannersPage extends StatelessWidget {
  AdminDesktopSellMyCarBannersPage({super.key});

  final AdminSellMyCarBannersController getxController =
      Get.put(AdminSellMyCarBannersController());
                ...
                Padding(
                  ...
                  child: ButtonWidget(
                    ...
                    onTap: () => _showAddBannerDialog(
                        type: AppConstants.bannerTypes.header),
                  ),
                )
              ],
            ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ButtonWidget(
                    ...
                    isLoading: false.obs,
                    onTap: () => _showAddBannerDialog(
                        type: AppConstants.bannerTypes.footer),
                  ),
                )
              ],
            ),
        ...
        child: Padding(
          ...
          child: Obx(() {
            return Column(
              ...
              children: [
                Text(
                  'Add ${type == AppConstants.bannerTypes.header ? 'Header' : 'Footer'} Banner',
                  style: const TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: type == AppConstants.bannerTypes.header
                        ? 'Title'
                        : 'Screen Name',
