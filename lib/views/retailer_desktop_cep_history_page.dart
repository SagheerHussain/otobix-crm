  ...
  Widget _buildRecentBidsList() {
    ...
    return Obx(() {
      ...
      final columns = <DataColumn>[
        ...
        const DataColumn(
            label: Text("Highest Bid",
                style: TextStyle(fontWeight: FontWeight.bold))),
        const DataColumn(
            label: Text("CEP", style: TextStyle(fontWeight: FontWeight.bold))),
        const DataColumn(
      ...
      final columnWidths = isOtobuy
          ? const [100, 150, 150, 250, 150, 100, 100, 100, 200, 80, 100, 150]
          : const [100, 150, 150, 250, 150, 100, 100, 100, 200, 80];
